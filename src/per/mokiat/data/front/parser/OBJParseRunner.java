...
package per.mokiat.data.front.parser;

import java.io.BufferedReader;
import java.io.IOException;

import per.mokiat.data.front.common.IFastFloat;
import per.mokiat.data.front.common.IFastInt;
import per.mokiat.data.front.common.OBJLimits;
import per.mokiat.data.front.error.WFCorruptException;
import per.mokiat.data.front.error.WFException;
import per.mokiat.data.front.parser.OBJTexCoord.Type;
import per.mokiat.data.front.scanner.IOBJScanner;
import per.mokiat.data.front.scanner.IOBJScannerHandler;
import per.mokiat.data.front.scanner.OBJLimitingScannerHandler;
import per.mokiat.data.front.scanner.OBJScanner;
