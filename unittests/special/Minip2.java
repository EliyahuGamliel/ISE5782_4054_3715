...
public class Minip2 {
    ...
    void pictureTest() throws IOException {
        ...
        constGeometries.add(modelParser.getFaces().scale(30).changeStartingPoint(new Point(20,25,0)).getTriangles().stream().map((e)->(Intersectable)e.setEmission(new Color(103,95,75)) //
        ...
        constGeometries.add(modelParser.getFaces().scale(30).rotate(30, new Vector(1,0,0)).changeStartingPoint(new Point(58,22,0)).getTriangles().stream().map((e)->(Intersectable)e.setEmission(new Color(58, 95, 11)) //
                .setMaterial(new Material().setkD(0.15).setkS(0.5).setShininess(300))).toArray(Intersectable[]::new));

        //coconut of Palm tree
        modelParser = new parser("scenes/coconut.obj") ;
        constGeometries.add(modelParser.getFaces().scale(20).changeStartingPoint(new Point(37,37,0)).getTriangles().stream().map((e)->(Intersectable)e.setEmission(new Color(150, 90, 62)) //
                .setMaterial(new Material().setkD(0.15).setkS(0.5).setShininess(300))).toArray(Intersectable[]::new));
        //endregion
