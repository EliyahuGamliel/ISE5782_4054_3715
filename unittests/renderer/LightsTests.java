...
public class LightsTests {
	...
	void trianglesMultiple() {
		...
		scene2.lights.add(new DirectionalLight(new Color(0, 255, 0), trDL));
	...
	public void sphereSpotSharp() {
		scene1.geometries.add(sphere);
		scene1.lights
				.add(new SpotLight(spCL, spPL, new Vector(1, 1, -0.5)).setNarrowBeam(0.5).setkL(0.001).setkQ(0.00004));
	...
	public void trianglesSpotSharp() {
		scene2.geometries.add(triangle1, triangle2);
		scene2.lights.add(new SpotLight(trCL, trPL, trDL).setNarrowBeam(1).setkL(0.001).setkQ(0.00004));
