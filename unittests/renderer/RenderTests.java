...
public class RenderTests {
	...
	void coolImageRotatedTest() {
		...
		ImageWriter imageWriter = new ImageWriter("cool image", 1000, 1000);
		...
		camera.moveRightLeft(-1000);
		camera.moveUpDown(-700);
		camera.spinRightLeft(-0.7);
		camera.spinUpDown(20);
